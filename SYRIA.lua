...
-----------------------------------------------------
if text == 'تنزيل من قلبي' and Mod(msg) then
database:del(bot_id..'Zahf:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' ♡ تم تنزيله من قلبك ')
end
if text == ("تاك لقلوبي") and Mod(msg) then
local list = database:smembers(bot_id..'Zahf:User'..msg.chat_id_)
t = "\n ♡ قائمة قلوبك في المجموعه \n≪━━━━━━SYRIA━━━━━━≫\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."» قلبك[@"..username.."]\n"
